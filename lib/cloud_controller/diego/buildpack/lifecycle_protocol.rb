      ...
      module Buildpack
        class LifecycleProtocol
          ...
          def lifecycle_data(staging_details)
            ...
            lifecycle_data.buildpacks                         = @buildpack_entry_generator.buildpack_entries(staging_details.lifecycle.buildpack_infos, staging_details.lifecycle.staging_stack)
